...
quiz(
  ...
  question("Para comprobar la normalidad de una muestra:", allow_retry = TRUE, random_answer_order = TRUE, 
    ...
    answer("usaría el test de Kolmogorov-Smirnov mediante el comando run.test", correct = FALSE)
  ), 
  question("Para comprobar la aleatoriedad de una muestra:", allow_retry = TRUE, random_answer_order = TRUE, 
    answer("usaría el test de Kolmogorov-Smirnov para dos muestras mediante el comando run.test de la librería 'tseries'.", correct = FALSE),
    ...
    answer("usaría el test de rachas mediante el comando run.test de la librería 'tseries'.", correct = TRUE)
  ), caption = ""
)
```

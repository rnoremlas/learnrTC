...
quiz(
  ...
  question("¿Calcularía el histograma de la variable estadística ``ojos''?", allow_retry = TRUE, random_answer_order = TRUE, 
    answer("Sí, con el comando *hist(ojos)*", correct = TRUE),
    ...
    answer("No, ya que es una variable estadística que toma un número infinito no numerable de valores", correct = FALSE)
  ), caption = ""
)
```

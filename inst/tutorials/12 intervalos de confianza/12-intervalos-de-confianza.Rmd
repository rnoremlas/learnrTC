...
quiz(
  ...
  question("En la construcción de un intervalo de confianza:", allow_retry = TRUE, random_answer_order = TRUE, 
    ...
    answer("se verifica siempre que el centro es el estimador puntual del parámetro deesconocido del que depende la distribución de probabilidad.", correct = FALSE)
  ), caption = ""
)
```  
...
quiz(
  question("Suponiendo que la variable aleatoria _salario_ se distribuye según una normal:", allow_retry = TRUE, random_answer_order = TRUE, 
           ...
           answer("usaría el comando var.test(salario, mu=5) para calcular un intervalo de confianza que permita determinar si el salario medio puede ser mayor a 5 al nivel de confianza del 95%.", correct = FALSE),
...
*Suponiendo que hay normalidad, ¿Se puede afirmar, a un nivel de confianza del 95%, que el salario medio es igual a 65.000 dólares? ¿Y al 99%? ¿Y al 100%? ¿Se puede afirmar, al 90% de confianza, que la media del tamaño de la vivienda es menor que 5000 pies cuadrados?*

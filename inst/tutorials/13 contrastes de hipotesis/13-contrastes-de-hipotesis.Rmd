...
quiz(
  ...
  question("Se verifica que la primera población tiene una varianza poblacional menor que la segunda si el intervalo de confianza para la diferencia de varianzas poblacionales correspondiente tiene:", allow_retry = TRUE, random_answer_order = TRUE, 
    answer("no se rechaza la hipótesis nula en la opción b).", correct = FALSE),
    answer("se rechaza la hipótesis nula en la opción a).", correct = FALSE),
